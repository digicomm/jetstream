  ...
  <DAuthenticationCard>
    ...
    <div class="p-5 md:p-8 grow">
      <DForm @submit.prevent="submit">
        ...
        <DFormGroup>
          <DFormInput id="password" v-model="form.password" :v-error-message="$v.password.$errors" :v-error="$v.password.$error" :form-error="form.errors.password" label="Password" name="password"
