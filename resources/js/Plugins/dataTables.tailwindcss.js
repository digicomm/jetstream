...
$.extend( DataTable.ext.classes, {
    ...
    sProcessing:   "dt-processing uk-panel flex flex-col rounded-lg shadow-sm bg-white overflow-hidden dark:text-gray-100 dark:bg-gray-800 p-4",
    tailwindcss: {
        paging: {
        ...
        table: 'dataTable min-w-full align-middle whitespace-nowrap',
        thead: {
        ...
        tbody: {
            row: 'even:bg-gray-100 dark:even:bg-gray-900/50 hover:bg-gray-200 dark:hover:bg-gray-900/25',
            cell: 'tbodyCell'
        },
        tfoot: {
            row: 'border-b border-gray-100 dark:border-gray-700/50',
