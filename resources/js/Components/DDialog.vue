...
const modalSizeClasses = {
  'xs': 'sm:w-xs sm:max-w-xs',
  'sm': 'sm:w-sm sm:max-w-sm',
  'md': 'sm:w-md sm:max-w-md',
  'lg': 'sm:w-lg sm:max-w-lg sm:min-w-lg',
  'xl': 'sm:w-xl sm:max-w-xl',
  '2xl': 'sm:w-2xl sm:max-w-2xl',
  '3xl': 'sm:w-3xl sm:max-w-3xl',
  '4xl': 'sm:w-4xl sm:max-w-4xl',
  '5xl': 'sm:w-5xl sm:max-w-5xl',
  '6xl': 'sm:w-6xl sm:max-w-6xl',
  '7xl': 'sm:w-7xl sm:max-w-7xl',
}

const iconVariantClasses = {
  success: 'text-emerald-700 bg-emerald-100 dark:text-emerald-100 dark:bg-emerald-900 dark:bg-opacity-75',
  danger: 'text-red-700 bg-red-100 dark:text-red-100 dark:bg-red-900 dark:bg-opacity-75',
  warning: 'text-orange-700 bg-orange-100 dark:text-orange-100 dark:bg-orange-900 dark:bg-opacity-75',
  info: 'text-blue-700 bg-blue-100 dark:text-blue-100 dark:bg-blue-900 dark:bg-opacity-75',
        ...
        <div :id="idBackdrop" :class="computedDialogClasses" ref="element" @click="backdropClick">
          ...
          >
            ...
            >
              ...
              >
                <slot name="header" v-if="!hideHeader && !bodyNotification">
                ...
                <slot name="bodyicon" v-if="bodyIcon">
                ...
                <slot name="bodydefault" v-if="bodyDefault">
                  <div class="p-5 grow">
                    <slot/>
                  </div>
                </slot>

                <slot name="bodynotification" v-if="bodyNotification">
                ...
                <slot name="footerbuttons" v-if="!hideFooter && !bodyNotification">
